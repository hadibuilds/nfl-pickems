...
export default function LoginPage() {
  ...
  return (
    <div className="w-full min-h-screen flex items-start justify-center px-6 pb-12" style={{ backgroundColor: '#1E1E20', paddingTop: 'calc(env(safe-area-inset-top, 0px) + 3rem)' }}>
